...
**Archive File**   |[](https://github.com/Planet-Source-Code/php-code-exchange-mysql-web-interface__8-117/archive/master.zip)
...
function listTables() {
  ...
  for( $i = 0; $i < $num; $i++ ) {
    ...
    echo "</td>\n";
    echo "<td>\n";
    echo "<a href='$PHP_SELF?action=queryData&dbname=$dbname&tablename=$tablename'>Query</a>\n";
    echo "</td>\n";
    echo "<td>\n";
...
function queryData() {
  ...
  for( $i = 0; $i < $num; $i++ ) {
    ...
    for( $j = 0; $j < $or; $j++ ) {
      ...
      echo "</select>\n";
      echo "<input type=text name=criteria1_$fieldname>\n";
      echo "</td>\n";
    }
    echo "</tr>\n";
  }
